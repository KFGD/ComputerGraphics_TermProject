...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	CDeviceManager* DM = CDeviceManager::CreateDeviceManager(hWnd);
	CBaseSceneManager* SM = new CBaseSceneManager();
	CGameManager* GM = CGameManager::CreateGameManager(hWnd, DM, SM);
	CScene scene;
	SM->AddScene(&scene);
	GM->Run();
