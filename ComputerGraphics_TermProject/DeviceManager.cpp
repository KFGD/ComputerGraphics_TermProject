...
bool CDeviceManager::InitializeDirect3D(HWND hWnd)
{
...
void CDeviceManager::UninitializeDirect3D()
{
...
//InitializeDirect3D
bool CDeviceManager::CreateDeviceAndSwapChain(HWND hWnd)
{
...
bool CDeviceManager::CreateRenderTargetView()
{
...
bool CDeviceManager::CreateDepthStencilBufferAndBuffer()
{
	return true;
}

void CDeviceManager::SetRenderTargets()
{
...
void CDeviceManager::SetViewports()
{
	//ViewPort 구조체
